...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VelocityRaptorCore/VelocityRaptorCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VelocityRaptorUI/VelocityRaptorUI.framework"
fi
